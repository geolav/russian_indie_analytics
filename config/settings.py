...
# ─── API Credentials ───────────────────────────────────────────────────────────
# Spotify (optional, fallback if Yandex fails)
SPOTIFY_CLIENT_ID: str = os.getenv("SPOTIFY_CLIENT_ID", "")
SPOTIFY_CLIENT_SECRET: str = os.getenv("SPOTIFY_CLIENT_SECRET", "")

# Yandex Music API (primary)
...
# Russian indie artists seed list for data collection
SEED_ARTISTS: list[str] = [
    "IC3PEAK", "Земфира", "ssshhhiiittt!", "shit! shit! shit!",
    # "Монеточка", "Shortparis", "Молчат Дома",
    # "Аигел", "Kate NV", "Порнофильмы", "Лауд", "Антоха МС",
    # "Нервы", "Therr Maitz", "Tesla Boy", "Kedr Livanskiy",
    # "Motorama", "Сансара", "Дора", "Хаски", "Flёur", "Сплин",
    # "Би-2", "Мумий Тролль", "Звери", "Иван Дорн", "Pompeya",
]
